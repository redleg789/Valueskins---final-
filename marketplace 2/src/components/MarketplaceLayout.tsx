        ...
        <div style={{
            ...
            <div style={{
                ...
                <nav style={{
                    ...
                    <NavItem href="/events" active={pathname === '/events'} label="Events">
                        <EventsIcon filled={pathname === '/events'} />
                    </NavItem>
...
function EventsIcon({ filled }: { filled: boolean }) {
    if (filled) {
        return (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
                <path d="M17 2H7a3 3 0 0 0-3 3v13a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4V5a3 3 0 0 0-3-3Zm-7 5h4a1 1 0 1 1 0 2h-4a1 1 0 1 1 0-2Zm6 9H8a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2Zm0-4H8a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2Z" />
            </svg>
        );
    }
    return (
